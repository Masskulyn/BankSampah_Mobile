...
import { CreditCard, Plus, Trash2, Edit, Building, Save, X, Check } from "lucide-react";
...
export function BankAccountModal({ isOpen, onClose }: BankAccountModalProps) {
  ...
  const bankOptions = [
    ...
    "Permata", "OCBC NISP", "Maybank", "BTN", "Jenius", "Jago"
  ];
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {accounts.map((account) => (
              <Card key={account.id} className={`${account.isDefault ? 'ring-2 ring-green-500 ring-offset-2' : ''}`}>
          ...
          <div className="bg-blue-50 p-3 rounded-lg border border-blue-200">
            <p className="text-sm text-blue-800">
              💡 Rekening yang ditandai "Utama" akan digunakan untuk pencairan saldo secara otomatis.
            </p>
          </div>
